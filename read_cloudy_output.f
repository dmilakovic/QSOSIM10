!=======================================================================
     ...
     &              coldens)
!=======================================================================
*      read files created by CLOUDY with metal absorption lines
      
*      input, character           : home         path to the home folder
*                                   descriptor   unique QSO designation
*                                   atom         atom for which output is to be read
*                                   ion          ion for which output is to be read              
*      input, integer             : nl           number of H I lines
*                                   s            number of H I lines with N_HI > 1e15 cm-2
*      input, logical array(nl)   : mask         mask of H I lines with N_HI > 1e15 cm-2
*                                                (T if N_HI > 1e15 cm-2)

*      output, real*8 array(nl)   : coldens      column densities of atom, ion 
*                                                read from CLOUDY output files
!=======================================================================
      ...
      call system('pwd')
      io=0
*     set counter of systems with N(HI) > 1e15 : t=0
      t=0    
*     for each of H I absorption systems, check if the mask = T. If true,
*     locate the CLOUDY output file and open it. Read the number of entries,
*     and populate the arrays containing data on the atom, ion, and column
*     density of that atomic species. Find the wanted atomic species (from
*     input) and return the column density value into a new array.
      do i=1,nl
         coldens(i)=0.0
