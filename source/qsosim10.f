...
! ---------------------------------------------------------------------
      ...
      write (6,*)'      Copyright (C) 2019 Milakovic & Webb'
      write (6,*)""
      write (6,*)"This program is free software: you can redistribute "
      write (6,*)"it and/or modify it under the terms of the GNU      "
      write (6,*)"General Public License as published by the Free     "
      write (6,*)"Software Foundation, either version 3 of the        "
      write (6,*)"License, or (at your option) any later version.     "
      write (6,*)""
      write (6,*)"This program is distributed in the hope that it will"
      write (6,*)"be useful, but WITHOUT ANY WARRANTY; without even   "
      write (6,*)"the implied warranty of MERCHANTABILITY or FITNESS  "
      write (6,*)"FOR A PARTICULAR PURPOSE.                           "
      write (6,*)"See the GNU General Public License for more details."
      write (6,*)"You should have received a copy of the GNU General  "
      write (6,*)"Public License along with this program.             "
      write (6,*)"If not, see https://www.gnu.org/licenses/.          "
! ---------------------------------------------------------------------
